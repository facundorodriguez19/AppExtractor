<x-app-layout>
    <div class="min-h-screen flex flex-col sm:justify-center items-center pt-6 sm:pt-0">
        <div class="w-full sm:max-w-md mt-6 px-6 py-8 bg-white shadow-2xl rounded-2xl border border-gray-100">
            <h2 class="text-3xl font-black text-center text-gray-900 mb-8">Entrar</h2>
            ...
            <form method="POST" action="{{ route('login') }}">
                ...
                <div class="space-y-6">
                    <div>
                        ...
                        <input type="email" name="email" required autofocus class="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-primary-500 transition">
                    </div>
                    <div>
