<x-app-layout>
    <div class="space-y-8">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
            <!-- Gráficos -->
            <div class="bg-white p-6 rounded-2xl shadow-sm border border-gray-100" x-data="chartsHandler()" x-init="init()">
            ...
            <div class="bg-white p-6 rounded-2xl shadow-sm border border-gray-100">
                ...
                <div class="space-y-4">
                    @forelse($ultimasNotas as $nota)
                        <a href="{{ route('notas.show', $nota) }}" class="flex items-center justify-between p-4 rounded-xl hover:bg-gray-50 transition border border-transparent hover:border-gray-100">
                            <div class="flex items-center space-x-4">
                                ...
                                <div>
                                    <p class="font-bold text-gray-900 truncate w-48">{{ $nota->empresa_emissora ?? 'Processando...' }}</p>
